...
class Camera < ActiveRecord::Base
  ...
  SENSORS 	= [:'APS-C', :'FF', :'APS-H', :'4/3', :'1" CX', :"1.7크롭", :'6.4x4.8mm', :'18x12mm', :'645(44x33mm)', :'S(45x30mm)', :'M3 20.5x16.4mm', :'M5 14x9.3mm', :'M6 27.6x18.4mm', :'M11', :'M15', :'M16', :'M17 18.1x13.5mm', :'M24', :'C14', :'X14', :'2/3"']
